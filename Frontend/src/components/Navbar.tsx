						...
						<div className="left valign-wrapper">
							<Link to="/">
								<div className="valign-wrapper items-center">
									...
									<div className="pl-3" id="logo-text">
										NetTruyenZ
									</div>
								</div>
							</Link>
						...
						<div className="table-cell w-1/5 pl-6 text-sm align-middle">
							<div className="right">
								<div className="flex">
									<button
										onClick={onSignIn}
										className="bg-transparent mr-2 focus:bg-red-500 font-semibold text-white py-2 w-28 border-2 border-white rounded"
									>
										<p>ĐĂNG NHẬP</p>
									</button>
									<button
										onClick={onSignUp}
										className="bg-transparent focus:bg-red-500 bg-red-600 font-semibold text-white py-2 border-2 w-28 border-red-600 rounded"
									>
										<p>ĐĂNG KÍ</p>
									</button>
								</div>
			...
			<div className="table w-full px-48 pb-9 pt-4 font-mono text-custom-xl">
				<div className="table-row center ">
					<div className="table-cell w-1/4 ">
						<a
							onClick={() => setNewDiv("home")}
							id="home"
							className="inline-flex border-b-4 border-black hover:text-red-600 hover:border-red-600"
						>
							<AiOutlineHome
					...
					<div className="table-cell w-1/4 ">
						...
						>
							<BsCardList
								...
								style={{ fontSize: "1.3em" }}
							></BsCardList>
							<NavLink to="/categories" className="mt-1">
								DANH SÁCH
							</NavLink>
						</a>
					</div>
					<div className="table-cell w-1/4 ">
						...
						>
							<RiChatFollowUpLine
								...
								style={{ fontSize: "1.3em" }}
							></RiChatFollowUpLine>
							<NavLink to="/follow" className="mt-1">
								THEO DÕI
							</NavLink>
						</a>
					</div>
					<div className="table-cell w-1/4 ">
						...
						>
							<BsClockHistory
								...
								style={{ fontSize: "1.3em" }}
							></BsClockHistory>
							<NavLink to="/history" className="mt-1">
								LỊCH SỬ
							</NavLink>
						</a>
					</div>
